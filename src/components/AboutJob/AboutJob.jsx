...
import ready from "../../Assets/aboutLady.png";
import down from "../../Assets/abt.png";
  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.business}>
        ...
        <p>
          NIIT's Corporate Learning Group (CLG) offers Managed Training Services
